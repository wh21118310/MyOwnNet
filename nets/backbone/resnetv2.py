...
"""
 @Time    : 2022/7/17
 @Author  : Donghui Lee
 @E-mail  : 121106010719@njust.edu.cn
 @File    : resnetv2.py
 @Function: ResNet_v2 Model, proposed the concept “pre activation" compared to resnet_v1.
            you can check the structure in BasicBlock and BottleBlock
...
def _resnet(arch, block, layers, pretrained, **kwargs):
    ...
    if pretrained:
        ...
        print("Load {} Weights Succeed!".format(arch))
    return model
