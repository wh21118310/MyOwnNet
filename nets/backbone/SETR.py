...
"""
    ...
    @Description : Rethinking Semantic Segmentation from a Sequence-to-Sequence Perspective with Transformers
                    CVPR2021, inspired by ViT, Original code based on MMSegmentation
    @Thinking with Chinese: Compared with ViT,author replace the classifier with Decoder,so, why not try to get the
    thought and use in my model?
"""
import torch
